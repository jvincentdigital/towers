  ...
  if (items.length === 0) {
    return (
      <main className="flex min-h-[60vh] flex-col items-center justify-center px-6 text-center">
        ...
        <h1 className="mb-2 text-2xl font-bold uppercase text-zinc-900">
          Your Cart is Empty
        </h1>
      ...
      <section className="mx-auto max-w-7xl px-6 py-12 md:py-16">
        <div className="grid gap-12 lg:grid-cols-3">
                    ...
                    <div className="mt-3 flex flex-wrap items-center gap-4">
                      ...
                      <div className="flex items-center overflow-hidden rounded-lg border border-zinc-300">
                        <button
                          ...
                          className="px-3 py-1.5 text-sm font-bold text-zinc-600 transition hover:bg-zinc-100"
                          aria-label="Decrease quantity"
                        >
                          &minus;
                        </button>
                        <span className="min-w-[2rem] border-x border-zinc-300 px-2 py-1.5 text-center text-sm font-semibold text-zinc-900">
                          {item.quantity}
                        </span>
                        <button
                          type="button"
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8 rounded-xl border border-zinc-200 bg-white p-6 shadow-sm">
        ...
        <form onSubmit={handlePlaceOrder} className="mt-16 max-w-3xl">
          <h2 className="mb-8 text-2xl font-bold uppercase tracking-wide text-zinc-900">
            Checkout
          </h2>

          {/* Personal Info */}
          <fieldset className="mb-10">
            <legend className="mb-4 text-sm font-bold uppercase tracking-widest text-zinc-500">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-zinc-300 px-4 py-2.5 text-zinc-900 outline-none transition focus:border-accent focus:ring-2 focus:ring-accent/30"
                />
              </div>
              <div>
                <label
          ...
          {/* Payment Placeholder */}
          <div className="mb-10 rounded-lg border-2 border-dashed border-zinc-300 bg-zinc-50 px-6 py-8 text-center">
